...
const taskRow = (name, toggleDisable) => {
  return(
    <tr>
      <td>
...
const tasks = [
  ...
  {name: 'Create 5 Paintings', toggleDisable: true}
]
          ...
          <Col md="6">
            <Card className="card-tasks">
              <Card.Header>
                ...
                <p className="card-category">From all ongoing projects</p>
              </Card.Header>
              <Card.Body>
                <div className="table-full-width">
                  <Table>
                    <tbody>
                      {tasks.map(task => taskRow(task.name, task.toggleDisable))}
                    </tbody>
                  </Table>
                </div>
              </Card.Body>
