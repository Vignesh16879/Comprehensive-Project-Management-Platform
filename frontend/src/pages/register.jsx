...
export default class Register extends Component {
    ...
    handleDecryption = (enc) => {
        const crypto = new CryptoUtils();
        const [success, data] = crypto.decrypt(enc);
    ...
    handleSubmitPage1 = (event) => {
        ...
        axios
            .post(
                `${process.env.REACT_APP_BACKEND_URL}/api/register/registerpage1/`,
    ...
    handleSubmitPage2 = (event) => {
        ...
        axios
            .post(
                `${process.env.REACT_APP_BACKEND_URL}/api/register/registerpage2/`,
                { "data" : data },
                { headers: { 'X-CSRFToken': csrftoken } }
            )
            .then((response) => {
    ...
    handleGetOTP = (event) => {
        ...
        axios
            .post(
                `${process.env.REACT_APP_BACKEND_URL}/api/register/registergetotp/`,
                { "data" : data },
                { headers: { 'X-CSRFToken': csrftoken } }
            )
            .then((response) => {
    ...
    handleSubmitPage3 = (event) => {
        ...
        axios
            .post(
                `${process.env.REACT_APP_BACKEND_URL}/api/register/registerpage3/`,
                { mobile1, mobile2, otp },
                { headers: { 'X-CSRFToken': csrftoken } }
            )
            .then((response) => {
                    ...
                    <div className="register-container">
                        <Container>
                            <Row>
                                <Col lg={12}>
                                    <br /><br /><br />
                                    <h3 className="text-light mb-3"><b>Register Now</b></h3>
