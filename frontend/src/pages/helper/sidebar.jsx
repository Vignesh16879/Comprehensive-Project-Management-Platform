...
export default class SideBar extends Component {
    render() {
        const { username, profileimage, page, children } = this.props;

        return (
            <>
                <div className="g-sidenav-show bg-gray-100">
                    <aside className="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-auto" id="sidenav-main" data-color="mama_colour">
                        <div className="sidenav-header">
                            <i className="fas fa-times p-3 cursor-pointer text-secondary text-auto opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
                            <a className="navbar-brand m-0" href="/" rel="noopener noreferrer">
                                <Image src={ logo } className="navbar-brand-img h-100" alt="logo" />
                                <span className="ms-1 font-weight-bold">DragonEyeX</span>
                            </a>
                        </div>
                        <hr className="horizontal auto mt-0" />
                        <div className="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
                            <ul className="navbar-nav">
                            <li className="nav-item">
                              
                                <a className={page == 'Dashboard' ? "nav-link active" : "nav-link"} href="/dashboard">
                          ...
                          <li className="nav-item mt-3">
                              <h6 className="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Manage Projects</h6>
                            </li>
                            
                            <li className="nav-item">
                                <a className={page == 'Assignments' ? "nav-link active" : "nav-link"} href="/assignments">
                                <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                    ...
                                    <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                        ...
                                        <g transform="translate(1716.000000, 291.000000)">
                                            ...
                                            <path className="color-background" d="M40.25,14 L24.5,14 C23.53225,14 22.75,14.78225 22.75,15.75 L22.75,38.5 L19.25,38.5 L19.25,22.75 C19.25,21.78225 18.46775,21 17.5,21 L1.75,21 C0.78225,21 0,21.78225 0,22.75 L0,40.25 C0,41.21775 0.78225,42 1.75,42 L40.25,42 C41.21775,42 42,41.21775 42,40.25 L42,15.75 C42,14.78225 41.21775,14 40.25,14 Z M12.25,38.5 L3.5,38.5 L3.5,24.25 L12.25,24.25 L12.25,38.5 Z M38.5,38.5 L29.75,38.5 L29.75,17.5 L38.5,17.5 L38.5,38.5 Z"></path>
                                            </g>
                                        </g>
                                        </g>
                                    </g>
                                ...
                                <span className="nav-link-text ms-1">Assignments</span>
                                </a>
                            </li>
                            ...
                            <li className="nav-item">
                            <a className={page == 'Manage Projects' ? "nav-link active" : "nav-link"} href="/manageprojects">
                              <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                                  <title>spaceship</title>
                                  <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                          ...
                          <li className="nav-item">
                            <a className={page == 'Add project' ? "nav-link active" : "nav-link"} href="/addproject">
                              <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                              ...
                              <span className="nav-link-text ms-1">Add Project</span>
                            </a>
                          </li>
                          ...
                          <li className="nav-item mt-3">
                              <h6 className="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Manage Self</h6>
                            </li>

                            <li className="nav-item">
                              <a className={page == 'Inbox' ? "nav-link active" : "nav-link"} href="/inbox">
                                <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                  <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                            ...
                            <li className="nav-item">
                                <a className={page == 'Transactions' ? "nav-link active" : "nav-link"} href="/transactions">
                                    <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                          ...
                          <li className="nav-item">
                              <a className={page == 'Profile' ? "nav-link active" : "nav-link"} href="/profile">
                                <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            ...
                            <li className="nav-item">
                              <a className={page == 'Settings' ? "nav-link active" : "nav-link"} href="/settings">
                                <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            ...
                            <li className="nav-item">
                              <a className={page == 'Logout' ? "nav-link active" : "nav-link"} href="/logout">
                                <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                  <svg width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                                    <title>settings</title>
                                    <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                      <g transform="translate(-2020.000000, -442.000000)" fill="#FFFFFF" fillRule="nonzero">
                                        <g transform="translate(1716.000000, 291.000000)">
