        ...
        return (
            <>
                <main className="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
                    <nav className="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl bg-auto" id="navbarBlur" data-scroll="true" data-color="auto">
                        <div className="container-fluid py-1 px-3" data-color="auto">
                            <nav aria-label="breadcrumb">
                                <ol className="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                                    <li className="breadcrumb-item text-sm">
                                        <a className="opacity-5 text-auto" href="javascript:;">Pages</a>
                                    </li>
                                    <li className="breadcrumb-item text-sm text-auto active" aria-current="page">{ page }</li>
                                </ol>
