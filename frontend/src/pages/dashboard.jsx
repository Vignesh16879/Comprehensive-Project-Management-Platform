                            ...
                            <Row className="mt-4">
                                            ...
                                            <Row>
                                                ...
                                                <Col lg={5} className="ms-auto text-center mt-5 mt-lg-0">
                                                    <div className="bg-gradient-primary border-radius-lg h-100">
                                                        <Image src="../assets/img/shapes/waves-white.svg" className="position-absolute h-100 w-50 top-0 d-lg-block d-none" alt="waves" />
                                                        <div className="position-relative d-flex align-items-center justify-content-center h-100">
                                                            <Image className="w-100 position-relative z-index-2 pt-4" src="../assets/img/illustrations/rocket-white.png" alt="rocket" />
                                                        </div>
                                                    </div>
                                                </Col>
                                            </Row>
                                ...
                                <Col lg={5}>
                                    <Card className="h-100 p-3">
                                        <div className="overflow-hidden position-relative border-radius-lg bg-secondary h-100" background="">
                                            <span className="mask bg-gradient-auto"></span>
                            ...
                            <Row className="mt-4">
                                <Col lg={5} className="mb-lg-0 mb-4">
                                    <Card className="z-index-2">
                                        <Card.Body className="p-3">
                                            <div className="bg-gradient-auto border-radius-lg py-3 pe-1 mb-3">
                                                <div className="chart">
                                                ...
                                                <Row>
                                                    <Col md={3} className="py-3 ps-0">
                                                        ...
                                                        <div className="progress w-75">
                                                            <div className="progress-bar bg-auto w-60" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                                        </div>
                                                    </Col>
                                                    <Col md={3} className="py-3 ps-0">
                                                        <div className="d-flex mb-2">
                                                        ...
                                                        <div className="progress w-75">
                                                            <div className="progress-bar bg-auto w-90" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
                                                        </div>
                                                    </Col>
                                                    <Col md={3} className="py-3 ps-0">
                                                        <div className="d-flex mb-2">
                                                        ...
                                                        <div className="progress w-75">
                                                            <div className="progress-bar bg-auto w-30" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                                                        </div>
                                                    </Col>
                                                    <Col className="py-3 ps-0">
                                                        <div className="d-flex mb-2">
                                                        ...
                                                        <div className="progress w-75">
                                                            <div className="progress-bar bg-auto w-50" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                                        </div>
                                                    </Col>
                                                </Row>
                                            </div>
